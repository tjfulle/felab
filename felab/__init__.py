...
p.add_argument(
    "-v", default=1, type=int, help="Level of verbosity [default: %(default)s]"
)
p.add_argument("-p", default=4, type=int, help="Print precision [default: %(default)s")
