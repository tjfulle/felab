...
class CPS4(CMDN):
    ...
    # otherwise.
    #
    #  For the 4 not isoparametric plane strain element, the x and y
    ...
    def __init__(self, label, nodes, coord, material):
        """4 node plane-stress stress-displacement element
        ...
        """
        super(CPS4, self).__init__(label, nodes, coord, material, t=1.0)
        self.t = 1.0
