...
class CPE4R(CMDN):
    ...
    def __init__(self, label, nodes, coord, material, t=1.0, hourglass_control=True):
        """4 node plane-strain stress-displacement element with reduced
        ...
        hourglass_control : bool
            Whether or not to use hourglass control

        """
        super(CPE4R, self).__init__(label, nodes, coord, material)
        self.t = t
