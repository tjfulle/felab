...
class CAX4(CMDN):
    """4-node isoparametric element stress-displacement axisymmetric element
    ...
    # otherwise.
    #
    #  For a 4 node isoparametric stress displacement element, the x and y
    ...
    def __init__(self, label, nodes, coord, material, t=1.0, formulation=1):
        ...
        t : float
            Ring thickness
        formulation : int
            The axisymmetric formulation
            1 -> Santos
            2 -> Felippa
        """
        super(CAX4, self).__init__(label, nodes, coord, material)
        self.t = t
        self.axisymmetric = formulation
