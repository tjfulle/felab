...
class CPE4RS(CMDN):
    ...
    # otherwise.
    #
    #  For the 4 node isoparametric stress displacement element, the x and y
    ...
    def __init__(self, label, nodes, coord, material, t=1.0):
        """4 node plane-strain stress-displacement element with
        ...
        """
        super(CPE4RS, self).__init__(label, nodes, coord, material)
        self.t = t
