...
def test_elemlibN_2_1():
    ...
    Ke = El.response(zeros(2), zeros(2), [0,0], 1., 1, 1, [], [], [1,0,2,1])
...
def test_elemlibN_2_2():
    ...
    Ke = El.response(zeros((2,2)),zeros((2,2)),[0,0],1.,1,1,[],[],[1,0,2,1])
...
def test_elemlibN_2_3():
    ...
    Ke = El.response(zeros((2,3)),zeros((2,3)),[0,0],1.,1,1,[],[],[1,0,2,1])
...
def test_elemlibN_2_4():
    ...
    K = El.response(zeros((2,2)),zeros((2,2)),[0,0],1.,1,1,[],[],[1,0,2,1])
